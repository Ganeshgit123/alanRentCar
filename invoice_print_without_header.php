...
<head>
<meta charset="UTF-8">
<!--<title>Invoice without Header</title> -->
<title>&nbsp;</title>
...
<div class="row">
<div class="col-6 pl-5 letter-title">
  <h5 class="text-left">Tax Registration No: <span style="text-indent: 45px;"><?php echo $cval['tax_no'];?></span></h5>
  <h5 class="text-left">Name of the Buyer:<span style="text-indent: 45px;">&nbsp;&nbsp;<?php echo $cval['client_name'];?></span></h5>
</div>
<div class="col-6 letter-title1">
...
<div class="col-9 pl-5 letter-title1">
  <div class="row inn">
