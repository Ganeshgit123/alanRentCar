...
e.estimation_date,e.po_number,e.credit_days,e.exclude_vat,e.client_id,e.expiry_date,e.payment_terms,
e.vat_amount,e.total,e.discount,e.client_name,e.ar_client_name,e.discount_vat,e.discount_total,e.total
...
<label for="inp-type-1" class="col-sm-3 control-label">Client / <span class="arabic">العملاء</span></label>
<div class="col-sm-9">
...
<input type="text" class="form-control issue_date" placeholder="mm/dd/yyyy" name="estimation_date" id="datepicker-autoclose" value="<?php echo $estimation_date; ?>">
...
<div class="form-group">
<label for="inp-type-1" class="col-sm-3 control-label">Expiry date / <span class="arabic">تاريخ الإنتهاء </span></label></label>
<div class="col-sm-9">
<div class="input-group">
<input type="text" class="form-control duedate" name="expiry_date" placeholder="mm/dd/yyyy" id="datepicker" value="<?php echo $expiry_date; ?>">
<span class="input-group-addon bg-primary text-white"><i class="fa fa-calendar"></i></span>
</div>  <!-- /.input-group -->
...
<!-- <div class="form-group">
<label for="inp-type-1" class="col-sm-3 control-label">PO Number</label>
<div class="col-sm-9">
...
<div class="form-group">
<label for="inp-type-1" class="col-sm-3 control-label">Payment Terms & Conditions</label>
<div class="col-sm-9">
<textarea class="form-control" id="payment_terms" name="payment_terms" placeholder="Payment Terms & conditions"><?php echo $payment_terms; ?></textarea>
</div>
</div>
</div>
...
<th>Discount / <span class="arabic_no_right">التخفيض</span></th>  
  ...
  <th></th>                                
  <th></th>
  <th><input type="text" class="form-control discount damt " name="discount" id="discount" value="<?php echo $discount;?>"/></th>
  <th ><input type="text" class="form-control discount dvat " name="discountVat" id="discountVat" value="<?php echo $discount_vat;?>"/></th>
  <th style="text-align:center;"><input type="text" class="form-control dVat ftotal " readonly name="dVat" id="dVat" value="<?php $vTotal=($discount_vat/100) * $discount; echo  $vTotal;?>"/></th>
  <th style="text-align:center;"><input type="text" class="form-control dTotal ftotal " readonly name="dTotal" id="dTotal" value="<?php echo $discount_total;?>"/></th>
  <th ></th>

</tfoot>
</table>
<div align="center">
<input type="submit" name="submit" class="btn btn-info" onclick="callResult()" value="submit" />
</div>
</div>  
...
if($(this).val() <= 0)
{
error += '<p>Invalid  Total Amount</p>';
return false;
}

}); 

$('#totalVatAmt').each(function(){

if($(this).val() <= 0)
{
error += '<p>Invalid  Vat Total </p>';
return false;
}
...
{
$.ajax({
url:"action/action_update_estimation.php",
method:"POST",
data:form_data,
success:function(data)
{
