...
<div class="box-title row">
    <div class='col-md-4'><h4>Add Vendor</h4></div>
...
<label for="exampleInputEmail1">Vendor Name (EN)<span class="required">*</span></label>
<input type="text" class="form-control" id="en_vname" placeholder="Vendor Name" name="en_vname">
</div>
<div class="form-group"> 
<label for="exampleInputEmail1">Company Name(EN)<span class="required">*</span></label>
<input type="text" class="form-control" id="en_company_name" name="en_company_name" placeholder="Enter Company Name"> 
</div>
<div class="form-group">
<label for="exampleInputEmail1">Vendor Address<span class="required">*</span> (Add (comma ,)for next line)</label>
<textarea class="form-control" id="en_address" name="en_address" placeholder="Vendor Address"></textarea>
</div>
<!-- <div class="form-group">
<label for="exampleInputEmail1">Contact Person No.(EN)<span class="required">*</span></label>
<input type="text" class="form-control" id="en_contact_person" name="en_contact_person" placeholder="Enter Contact Person">
</div> -->

<div class="form-group">
<label for="exampleInputEmail1">Phone No<span class="required">*</span></label>
<input type="text" class="form-control" id="en_phone" name="en_phone" placeholder="Enter Phone">
</div>

<div class="form-group">
<label for="exampleInputEmail1">Email<span class="required">*</span></label>
<input type="text" class="form-control" id="en_email" name="en_email" placeholder="Enter Email">
</div>

<div class="form-group">
<label for="exampleInputEmail1">VAT Number<span class="required">*</span></label>
<input type="text" class="form-control" id="vat_id" name="vat_id" placeholder="Enter your VAT Id">
</div>
		</div>
		<div class="col-md-6">
<div class="form-group">
<label for="exampleInputEmail1" class="arabic"><span class="required">*</span>اسم البائع</label>
<input type="text" class="form-control arabic" id="ar_vname" placeholder="اسم البائع" name="ar_vname" pattern="[a-zA-Z. ]{1,}" >
</div>
<div class="form-group">
<label for="exampleInputEmail1" class="arabic"><span class="required">*</span>إسم الشركة</label>
<input type="text" class="form-control arabic" id="ar_company_name" name="ar_company_name" placeholder="إسم الشركة">
</div>
<div class="form-group">
...
<input type="text" class="form-control arabic" id="ar_contact_person" name="ar_contact_person" placeholder="الشخص الذي يمكن الاتصال به" >
</div> -->

<div class="form-group">
<label for="exampleInputEmail1" class="arabic"><span class="required">*</span>رقم الجوال</label>
<input type="text" class="form-control arabic" id="ar_phone" name="ar_phone" placeholder="رقم الجوال" oninput="setCustomValidity('')">
</div>
...
if (en_vname=='' || en_address=='' || en_company_name=='' ||
  vat_id=='' || ar_vname=='' || ar_address=='' || en_email=='' || ar_company_name== '' || ar_phone== '' ) {
...
type: "GET",
url: 'action/action_create_vendor.php',
data: "en_vname="+en_vname+"&en_address="+en_address+"&vat_id="+vat_id+"&ar_vname="+ar_vname+"&ar_address="+ar_address+"&en_phone="+en_phone+"&en_email="+en_email+"&en_company_name="+en_company_name+"&ar_phone="+ar_phone+"&ar_company_name="+ar_company_name, 
