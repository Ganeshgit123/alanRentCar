...
// $listVendor=listVendors();

$query = "SELECT v.en_vname,v.ar_vname,v.en_address,v.ar_address,v.en_contact_person,v.ar_contact_person,(v.id)vendorId,b.bill_date,b.po_number,b.credit_days,b.due_date,b.exclude_vat,b.vat_amount,b.total,b.received_amount,b.payment_terms,b.estimation,v.en_phone,v.ar_phone FROM bill b,vendor v where b.vendor_id=v.id and b.id=".$billId;
...
<h4 class="box-title">Bill</h4>
<div class="card-content">

<div class="col-lg-6 col-xs-12">

<div class="form-group">
<label for="inp-type-1" class="col-sm-3 control-label">Estimation  / <span class="arabic">التسعيرة</span></label>
<div class="col-sm-9">
<input class="form-control ponumber" type="text" name="estimation"  id="estimation" value="<?php echo $estimation; ?>" readonly>
</div>
</div>

<div class="form-group">
<label for="inp-type-1" class="col-sm-3 control-label">Vendor / <span class="arabic">البائع</span></label>
<div class="col-sm-9">
	<input type="hidden"  class="form-control" name="id" id="id" value="<?php echo $billId; ?>" readonly>
		<input type="hidden"  class="form-control" name="vendor_id" id="vendor_id" value="<?php echo $cId; ?>" readonly>
	<input type="text"  class="form-control"  value="<?php echo $en_vname.'/'.$ar_vname; ?>" readonly>

	<!-- <input type="text"  class="form-control" name="vendor_id" id="vendor_i" value="<?php echo $en_vname.'/'.$ar_vname; ?>" readonly> -->
...
<div class="col-sm-9">
<div class="input-group">
<input type="text" class="form-control bill_date" placeholder="mm/dd/yyyy" name="bill_date" id="datepicker-autoclose" value="<?php echo $bill_date; ?>">
<span class="input-group-addon bg-primary text-white"><i class="fa fa-calendar"></i></span>
</div>
</div>
</div>
...
<div class="col-sm-9">
<textarea class="form-control ponumber" type="text" id="payment_terms" name="payment_terms"><?php echo $payment_terms; ?></textarea>
</div>
</div>
...
<div class='col-sm-9'>
<input class='form-control ponumber' type='text' name='en_phone' value='<?php echo $en_phone; ?>' readonly=''>
</div>
</div>

<div class='form-group'>
<label for='inp-type-1' class='col-sm-3 control-label arabic'>الشخص الذي يمكن الاتصال به</label>
<div class='col-sm-9'>
<input class='form-control ponumber arabic' type='text' name='ar_phone' value='<?php echo $ar_phone; ?>' readonly=''>
</div>
</div>
</div>
</div>
...
$count = 0;
$query2 = "SELECT (p.id)pId,bd.product_id,p.en_pname, p.en_description , bd.description,bd.ar_description,bd.qty,bd.uom,bd.price,bd.vat,
bd.vat_amount,bd.row_total FROM bill_details bd, products p, bill b where bd.product_id=p.id and b.id=bd.bill_id and b.id=".$billId;
...
?>	
<tr>
<td  width="30"><input type="text" readonly class="form-control s_no " name="s_no[]" id="s_no_1" value="<?php echo $count; ?>"/></td>
...
<div align="center">
<input type="submit" name="submit" class="btn btn-info" onclick="callResult()" value="Update" />
</div>
</div>  
...
$.ajax({
url:"product_description_for_bill.php",
method:"POST",
...
// alert ($('#payment_terms'.val());

if(error == '')
{
$.ajax({
url:"action/action_update_bill.php",
method:"POST",
data:form_data,
success:function(data)
{
//alert(data);
if(data != ''){
window.location.href = 'print_sidebar_bill.php?bill_id='+data;
