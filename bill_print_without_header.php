...
<head>
<meta charset="UTF-8">
<!-- <title>Bill Print without Header</title> -->
<title>&nbsp; </title>
...
<div class="row">
<div class="col-6 pl-5 py-2 letter-title">
  <h5 class="text-left">Tax Registration No: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $vat_id;?></h5>
  <h5 class="text-left">Name of the Buyer:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $en_vname;?></h5>
</div>
<div class="col-6 letter-title1">
...
<div class="col-9 letter-title1">
  <div class="row inn2">
    ...
    <div class="col-5 lis"><h5><?php echo $bill_date;?></h5></div>
  </div>
  <div class="row inn2">
...
<div class="row inn2">
    ...
    <div class="col-5 lis"><h5><?php echo $due_date;?></h5></div>
</div>
<div class="row inn2">
...
<td class="arabic_font"><?php echo $obj['ar_description'];?></td>
...
<div class="col-5 pl-5 py-2 letter-title bank">
  <div class="row">
    <div class="col-12"><h5 class="text-left">Payment Terms</h5>
   <h5 class="text-left"> 
      <?php  
      $input = $payment_terms; 
      $output = str_replace(',', '<br />', $input);
