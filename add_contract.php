...
<div class="col-sm-9">
<input class="form-control project_name" type="text" name="project_name" placeholder="Project Name">
</div>
</div>
...
<div class="col-sm-9">
<input class="form-control domain_name" type="text" name="domain_name" placeholder="Domain Name">
</div>
</div>
...
<div class="col-sm-9">
<input class="form-control service_provider" type="text" name="service_provider">
</div>
</div>
...
<div class="col-sm-9">
<textarea class="form-control project_details" id="project_details" name="project_details"></textarea>
</div>
</div>
...
<div class="col-sm-9">
<textarea class="form-control fees_details" id="fees_details" name="fees_details"></textarea>
</div>
</div>
...
<div class="col-sm-9">
<textarea class="form-control project_deliverable" id="project_deliverable" name="project_deliverable"></textarea>
</div>
</div>
...
<div class="col-sm-9">
<input class="form-control project_timeline" type="text" name="project_timeline">
</div>
</div>
</div>
...
<div class="form-group">
<div class="col-sm-9">
<input class="form-control ar_project_name arabic" type="text" name="ar_project_name" placeholder="اسم المشروع">
</div>
...
<div class="form-group">
<div class="col-sm-9">
<input class="form-control ar_domain_name arabic" type="text" name="ar_domain_name" placeholder="اسم النطاق">
</div>
...
<div class="form-group">
<div class="col-sm-9">
<input class="form-control ar_service_provider arabic" type="text" name="ar_service_provider" placeholder="مقدم الخدمة">
</div>
...
<div class="form-group">
<div class="col-sm-9">
<textarea class="form-control arabic" id="ar_project_details" name="ar_project_details"></textarea>
</div>
...
<div class="form-group">
<div class="col-sm-9">
<textarea class="form-control arabic" id="ar_fees_details" name="ar_fees_details"></textarea>
</div>
...
<div class="form-group">
<div class="col-sm-9">
<textarea class="form-control arabic" id="ar_project_deliverable" name="ar_project_deliverable"></textarea>
</div>
...
<div class="col-sm-9">
<div class="input-group">
<input type="text" class="form-control star_date" placeholder="mm/dd/yyyy" name="star_date" id="datepicker">
<span class="input-group-addon bg-primary text-white"><i class="fa fa-calendar"></i></span>
</div>
</div>
...
<div class="form-group">
<div class="col-sm-9">
<input class="form-control ar_project_timeline arabic" type="text" name="ar_project_timeline">
</div>
...
<td  width="200" ><input type="text" id="en_timeline_desc<?php echo $count; ?>"  name="en_timeline_desc[]" class="form-control en_timeline_desc"/></td>

<td  width="200" ><input type="text" id="ar_timeline_desc<?php echo $count; ?>"  name="ar_timeline_desc[]" class="form-control ar_timeline_desc"/></td>

<td  width="200" ><input type="text" id="days<?php echo $count; ?>"  name="days[]" class="form-control days" /></td>
...
$.ajax({
url:"action/action_insert_contract.php",
method:"POST",
data:form_data,
