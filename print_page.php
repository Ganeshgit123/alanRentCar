...
<div class='col-md-2'></div>
    ...
    <div class='col-md-4'> 
       <!-- <a href='estimation.php' id="" target="_blank" data-remodal-target="remodal"> -->
        <button class="btn btn-warning" style="font-size: 16px;line-height: 26px;padding: 8px 25px;border: none;font-weight: 500;" data-remodal-target="remodal">Print</button>
        <!--</a>-->
        <a href='update_bill.php?bill_id=<?php echo $obj['billId'];?>'><button class="btn btn-info" style="font-size: 16px;line-height: 26px;padding: 8px 25px;border: none;font-weight: 500;">Edit</button></a>
    </div>
</div>
...
<div class="row" style="margin-top: 20px;">
  ...
  <div class="col-md-4 offset-8">
    <h2 class="arabic_font text-center">PURCHASE ORDER/فاتورة</h2>
  </div>
</div>
<?php
...
<div class="col-6 letter-title1">
  <h5><?php echo $vat_id;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="arabic_font">رقم التسجيل الضريبي</span> </h5>
  <h5><?php echo $ar_vname;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="arabic_font">اسم المشتري</span></h5>
</div>
</div>
</div>
...
<div class="col-9 py-2 letter-title1">
  ...
  <div class="row inn2">
    ...
    <div class="col-5 lis"><h5>717v1</h5></div>
  </div>
<div class="row inn2">
...
<td><?php echo $obj['ar_description'];?></td>
...
<p class="text-center mt-3"><em>*This is System generated invoice .</em></p>
</div>
<!-- /.row small-spacing -->   
</div>
</div>
...
<div class="remodal" data-remodal-id="remodal" role="dialog" aria-labelledby="modal1Title" aria-describedby="modal1Desc">
    ...
    <a href="bill_print_with_header.php?bill_id=<?php echo $obj['billId'];?>" class="remodal-confirm" target="_blank">Yes</a>
    <a href="bill_print_without_header.php?bill_id=<?php echo $obj['billId'];?>" class="remodal-cancel" target="_blank">No</a>
</div>
