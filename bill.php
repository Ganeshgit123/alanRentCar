...
<label for="inp-type-1" class="col-sm-3 control-label">Estimation No  / <span class="arabic">التسعيرة</span></label>
<div class="col-sm-9">
<input class="form-control ponumber" type="text" name="estimation"  id="estimation" value="">
</div>
</div>
...
<?php
foreach($listVendor as $cval){?>

<option value="<?php echo $cval['id']; ?>"><?php echo $cval['en_vname']; ?></option>
<?php } ?>
</select>
</div>
</div>
...
<div class="col-sm-9">
<input class="form-control ponumber" type="text" name="ponumber" value="">
</div>
</div>
...
<div class="col-sm-9">
<textarea class="form-control ponumber" type="text" id="payment_terms" name="payment_terms" value=""></textarea>
</div>
</div>
...
<th style="text-align:center;" >
    <input type="text" class="form-control totalPrice ftotal " name="totalPrice" id="totalPrice" value="0"></th>
<th></th>
<th style="text-align:center;" >
<input type="text" class="form-control totalVatAmt ftotal " name="totalVatAmt" id="totalVatAmt" value="0"> </th>
<th style="text-align:center;" >
  <input type="text" class="form-control totalAmt ftotal " name="totalAmt" id="totalAmt" value="0"></th>
<th></th>
...
<th style="text-align:center;" >
  <input type="text" class="form-control dTotal ftotal " name="dTotal" id="dTotal" value="0"></th>
<th ></th>
 -->
</tfoot>
</table>
...
{
$.ajax({
url:"action/action_insert_bill.php",
method:"POST",
data:form_data,
success:function(data)
{
