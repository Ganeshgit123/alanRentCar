...
<head>
<meta charset="UTF-8">
<title>Estimation Without Header</title>
...
<div class="row">
<div class="col-6 pl-5 letter-title" style="margin-top: 0;">
  <div class="row">
    <div class="col-2"><h5>From</h5></div>
    <div class="col-10"><h5 class="text-left">
    <?php  
    echo $en_name;
    echo "<br>"; 
    $input = $en_address; 
...
<div class="row">
<div class="col-6 pl-5 letter-title">
  <h5 class="text-left">Tax Registration No: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $tax_no;?></h5>
  <h5 class="text-left">Name of the Buyer:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $client_name;?></h5>
</div>
<div class="col-6 letter-title1">
...
<div class="row">
<div class="col-5 pl-5 letter-title bank">
  <div class="row">
    <div class="col-12">
      <h5 class="text-left">Payment Terms :</h5><h5 class="text-left"> 
      <?php  
      $input = $payment_terms; 
      $output = str_replace(',', '<br />', $input);
      echo $output;  
