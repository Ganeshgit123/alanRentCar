...
<head>
<meta charset="UTF-8">
<title>Estimation With Header</title>
...
$query = "select (e.id)estimation_id,e.client_id,e.estimation_date,e.po_number,e.credit_days,e.client_name,e.ar_client_name,e.expiry_date,e.exclude_vat,e.payment_terms,e.discount_total,e.discount,e.discount_vat,
