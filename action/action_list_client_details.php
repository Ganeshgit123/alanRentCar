...
<div class='col-sm-9'>
<input class='form-control ponumber' type='text' name='en_phone_no' value='" . $cval['en_phone_no']. "' readonly=''>
</div>
</div>
...
<div class='col-sm-9'>
<input class='form-control ponumber arabic' type='text' name='ar_phone_no' value='" . $cval['ar_phone_no']. "' readonly=''>
</div>
</div>
</div>
